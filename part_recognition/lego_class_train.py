...
def train(train_data, train_labels, estimator, sess):
  ...
  estimator.train(
      ...
      steps=20000,
      hooks=[logging_hook])
  #saver.save(sess, "/tmp/new_lego_convnet_model.ckpt")

def evaluate (eval_data, eval_labels, estimator, sess):
  lego_classifier = tf.estimator.Estimator(
        model_fn=cnn_model_fn, model_dir="/usr/src/lego_classification/part_recognition/models")
...
def main(unused_argv):
  ...
  with tf.Session() as sess:
    ...
    # train(train_data, train_labels, lego_classifier, sess)
    evaluate(eval_data, eval_labels, lego_classifier, sess) 
